...
greeting = f"Hello, my name is {name}"       # "Привіт, мене звати Марія"
age_info = f"I am {age} years old"           # "Мені 22 роки"
height_info = f"My height is {height} m"     # "Мій зріст 1.65 м"
